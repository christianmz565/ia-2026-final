...
How Much Does an AlexNet Architecture Overﬁt?
...
Number of examples per class (linear)
...
and 1300 is nearly zero, indicating that the amount of overﬁt is slight. In this region the validation
...
each n ∈{1300, 1000, 750, 500, 250, 100, 50, 25, 10, 5, 2, 1}. The case of n = 1300 is the complete
...
validation accuracy would not improve signiﬁcantly when using an AlexNet model with much more

data, and thus, that the degree of overﬁt is not severe.
