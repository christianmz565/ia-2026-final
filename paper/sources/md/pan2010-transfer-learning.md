...
featurespaceX anda marginalprobability distribution PðXÞ,

whereX ¼ fx1; . . . ; xng 2 X.Forexample,ifourlearningtask
...
feature,thenX isthespaceofalltermvectors,xi is theithterm
...
i.e., PðXSÞ 6¼ PðXTÞ, where XSi 2 XS and XTi 2 XT. As an
...
and YTi 2 YT. In our document classification
...
data as DS ¼ fðxS1; yS1Þ; . . . ; ðxSnS ; ySnS Þg, where xSi 2 X S is
...
DT ¼ fðxT1; yT1Þ; . . . ; ðxTnT ; yTnT Þg, where the input xTi is in
...
knowledge,which correspondstothe“howtotransfer”issue.
...
Thus, the condition DS 6¼ DT implies that either XS 6¼ XT or
...
domains are different, i.e., XS 6¼ X T, or 2) the feature spaces
...
No labeled data in the source domain are
...
target domains are different, XS 6¼ XT.

b.

The feature spaces between domains are the

same, XS ¼ XT, but the marginal probability
...
norm of A is defined as kAkr;p :¼ ðPd
...
representations UTXT, UTXS and the parameters, A, of the
...
probabilities PðyTjxTÞ and PðySjxSÞ. Liao et al. [31]
...
target domains are different, XS 6¼ XT, and 2) the feature

spaces between domains are the same, XS ¼ X T, but the
...
Therefore,byaddingdifferent penaltyvaluestoeachinstance
...
PðxTiÞ directly by matching the means
...
to matrix W ¼ ½w1w2 . . . wm. Let W ¼ UDV T, then  ¼ UT
...
the augmented feature vector to build models. The augmen-

ted feature vector contains all the original feature xi
...
and Kij ¼ kðxi; xjÞ. KS;S and KT;T are kernel matrices for
...
It can beproved thati ¼

PðxSiÞ

PðxTiÞ directly, based on the
...
transductive transfer learning problems. For more informa-
...
a high-dimensional feature space, where standard discrimi-
...
[62] analyzed the uniform convergence bounds for algo-

rithms that minimized a convex combination of source and
...
unaware classifier toward a target distribution and take the
...
classification algorithm that extended the traditional prob-

abilistic latent semantic analysis (PLSA) algorithm to
...
transductive transfer learning setting are under unsuper-
...
predictive function fTðÞ7 in DT using the knowledge in DS and

T S, where T S 6¼ T T and YS and YT are not observable.
...
task. Some works have been exploited to analyze related-

ness among tasks and task clustering techniques, such as
...
Ið; Þ is the mutual information between two random
...
XS, and ~Z are corresponding clusters of XT, XS, and Z,

respectively. The goal of STC is to learn ~
...
for localization around 145:5  37:5 m2 in two

different time periods.

4.

Sen. This data set was first used in [8].11 This data
...
instance learning algorithm, which can automatically identi-

fy the relevant feature subset and use inductive transfer for
...
rithms, pLWE and LWE, on the 20 Newsgroups3, compared
...
descent algorithm with Huber loss, SCL represents a linear
...
appropriately for real-world applications can indeed im-

prove the performance significantly compared to the
...
Reuters-21578,9 have been preprocessed for a trans-

fer learning setting by some researchers. The data in
...
Berkeley provided a MATLAB toolkit for transfer learn-

ing.13 The toolkit contains algorithms and benchmark data
...
auxiliary rating matrix. They then constructed a cluster-

level rating matrix known as a codebook. By assuming the
...
tial machine learning as well. For example, Kuhlmann and
...
parameter-transfer approach, and the relational-knowledge-
...
[10] M.E. Taylor and P. Stone, “Cross-Domain Transfer for Reinforce-

ment Learning,” Proc. 24th Int’l Conf. Machine Learning (ICML ’07),

pp. 879-886, 2007.

[11] X. Yin, J. Han, J. Yang, and P.S. Yu, “Efficient Classification across
...
[13] E. Baralis, S. Chiusano, and P. Garza, “A Lazy Approach to

Associative Classification,” IEEE Trans. Knowledge and Data Eng.,

vol. 20, no. 2, pp. 156-171, Feb. 2008.

[14] X. Zhu, “Semi-Supervised Learning Literature Survey,” Technical
...
so far focused on improving generalization across differ-

ent distributions between source and target domains or
...
[15] K. Nigam, A.K. McCallum, S. Thrun, and T. Mitchell, “Text
...
solve other challenging applications, such as video classi-

fication, social network analysis, and logical inference.
...
Sensitive Learning by Cost-Guided Iterative Classification Filter-

ing,” IEEE Trans. Knowledge and Data Eng., vol. 18, no. 10, pp. 1435-

1440, Oct. 2006.

[19] Q. Yang, C. Ling, X. Chai, and R. Pan, “Test-Cost Sensitive

Classification on Data with Missing Values,” IEEE Trans. Knowl-

edge and Data Eng., vol. 18, no. 5, pp. 626-638, May 2006.

[20] Learning to Learn. S. Thrun and L. Pratt, eds. Kluwer Academic

Publishers, 1998.

[21] R. Caruana, “Multitask Learning,” Machine Learning, vol. 28, no. 1,
...
[23] H. Daume´ III and D. Marcu, “Domain Adaptation for Statistical

Classifiers,” J. Artificial Intelligence Research, vol. 26, pp. 101-126,

2006.

[24] B. Zadrozny, “Learning and Evaluating Classifiers under Sample
...
[25] H. Shimodaira, “Improving Predictive Inference under Covariate
...
[28] W. Dai, G. Xue, Q. Yang, and Y. Yu, “Transferring Naive Bayes
...
ods in Natural Language, pp. 120-128, July 2006.
...
Transfer Learning,” Proc. 14th ACM SIGKDD Int’l Conf. Knowledge
...
Proc. 20th Ann. Conf. Neural Information Processing Systems, pp. 25-
...
of Artificial Intelligence (AAAI) Conf. Artificial Intelligence, pp. 677-
...
Kolmogorov Complexity: Basic Theory and Empirical Evalua-

tions,” Proc. 20th Ann. Conf. Neural Information Processing Systems,
...
degrees from the Applied Mathematics Depart-

ment, Sun Yat-sen University, China, in 2003
...
include transfer learning, semisupervised learn-

ing, and their applications in pervasive comput-

ing and Web mining. He is a member of the
...
gence, pp. 1383-1388, July 2008.

[79] V.W. Zheng, S.J. Pan, Q. Yang, and J.J. Pan, “Transferring Multi-

Device Localization Models Using Latent Multi-Task Learning,”
...
tion and Inductive Transfer,” Proc. 25th Int’l Conf. Machine
...
search interests are data mining and machine

learning, AI planning, and sensor-based activ-

ity recognition. He is a fellow of the IEEE, a
...
[84] X. Shi, W. Fan, and J. Ren, “Actively Transfer Domain Knowl-

edge,” Proc. European Conf. Machine Learning and Knowledge
