...
El dataset filtrado contiene un total de 3,612 imágenes en formato JPG con una resolución espacial fija de 2800 por 1024 píxeles @Nomihsa2024KaggleWood. El conjunto almacena 9,211 cajas delimitadoras anotadas distribuidas en 8 categorías de defectos superficiales. En promedio, cada imagen contiene 2.55 defectos, alcanzando un máximo de 15 defectos por imagen. La @fig:piechart-clases ilustra la distribución porcentual de frecuencia para cada clase de defecto.
...
Las anotaciones proporcionan coordenadas normalizadas de cajas delimitadoras en formato YOLO. La distribución de clases refleja las condiciones reales de producción industrial @Kodytek2022Dataset. Las categorías mayoritarias corresponden a nudos vivos con 3,905 anotaciones (44.2%) y nudos muertos con 2,835 anotaciones (31.9%), representando el 76.1% del total. Las categorías intermedias incluyen resina con 639 anotaciones (7.1%), nudos con grietas con 410 anotaciones (5.9%) y grietas con 505 anotaciones (5.6%). Las categorías minoritarias comprenden médula con 204 anotaciones (2.2%), cuarcita con 129 anotaciones (1.9%) y nudos faltantes con 109 anotaciones (1.3%). El ratio de desequilibrio calculado alcanza un valor aproximado de 35.82. La @fig:defectos-ejemplo muestra ejemplos representativos de las ocho categorías de defectos anotadas en el conjunto de datos.
