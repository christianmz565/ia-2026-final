...
Cascade R-CNN representa al paradigma de dos etapas. Posee una arquitectura convolucional basada en ResNet-50 con Feature Pyramid Network (FPN) @cai2018cascade. Se entrena durante 12 épocas con optimizador AdamW con learning rate de 0.0001 y weight decay de 0.0001, batch size de 8 y resolución de entrada de 640 por 640 píxeles. La evaluación de validación se ejecuta en cada época utilizando la métrica COCO bbox, y se selecciona el checkpoint con mayor mAP bbox.
...
El dataset es de acceso público a través de Kaggle (https://www.kaggle.com/datasets/nomihsa965/large-scale-image-dataset-of-wood-surface-defects). El código fuente del pipeline de experimentación está disponible en el repositorio https://github.com/christianmz565/ia-2026-final.
